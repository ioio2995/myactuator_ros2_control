...
#include "test_myactuator_broadcaster.hpp"
...
using myactuator_broadcaster::CMD_MY_ITFS;
using myactuator_broadcaster::control_mode_type;
using myactuator_broadcaster::STATE_MY_ITFS;

class MyactuatorBroadcasterTest : public MyactuatorBroadcasterFixture<TestableMyactuatorBroadcaster>
{
};

TEST_F(MyactuatorBroadcasterTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(MyactuatorBroadcasterTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(MyactuatorBroadcasterTest, activate_success)
{
  SetUpController();
...
TEST_F(MyactuatorBroadcasterTest, update_success)
{
  SetUpController();
...
TEST_F(MyactuatorBroadcasterTest, deactivate_success)
{
  SetUpController();
...
TEST_F(MyactuatorBroadcasterTest, reactivate_success)
{
  SetUpController();
...
TEST_F(MyactuatorBroadcasterTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(MyactuatorBroadcasterTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(MyactuatorBroadcasterTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(MyactuatorBroadcasterTest, publish_status_success)
{
  SetUpController();
...
TEST_F(MyactuatorBroadcasterTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
