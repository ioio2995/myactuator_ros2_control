...
controller_interface::CallbackReturn MyactuatorBroadcaster::on_init()
{
  ...
  try
  {
    param_listener_ = std::make_shared<myactuator_broadcaster::ParamListener>(get_node());
  }
  ...
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  ref_subscriber_ = get_node()->create_subscription<ControllerReferenceMsg>(
    ...
    std::bind(&MyactuatorBroadcaster::reference_callback, this, std::placeholders::_1));
...
void MyactuatorBroadcaster::reference_callback(const std::shared_ptr<ControllerReferenceMsg> msg)
{
...
controller_interface::InterfaceConfiguration MyactuatorBroadcaster::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration MyactuatorBroadcaster::state_interface_configuration() const
{
...
PLUGINLIB_EXPORT_CLASS(
  myactuator_broadcaster::MyactuatorBroadcaster, controller_interface::ControllerInterface)
